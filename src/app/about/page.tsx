      ...
      <main className="flex-1">
        ...
        <div className="bg-slate-900 text-white py-20 px-6 lg:px-12">
          <div className="max-w-4xl mx-auto text-center space-y-6">
            <h1 className="text-4xl md:text-6xl font-bold">About Edtech</h1>
            <p className="text-lg md:text-xl text-slate-300">
              We are on a mission to build the world's most trusted network of
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-slate-600 dark:text-slate-400 text-lg leading-relaxed">
                Edtech was founded with a simple idea: it should be easy for
                talented professionals to find great clients, and just as easy
                for clients to find reliable experts. We cut through the noise
                of traditional freelance marketplaces by focusing on quality,
